...
const Unity = () => {
  return (
    <Course
      ...
      extraContent={(
        <div>
          <a className='text-ice-blue hover:text-med-blue hover:cursor-pointer duration-200' target='_blank' href='https://jcb5150.itch.io/beat'>Here's the game you'll learn how to make!</a>
        </div>
      )}
    />
	)
